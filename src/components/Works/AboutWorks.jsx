...
// import styles from "./AboutWorks.module.scss";
// import Modal from "./Modal";
// import useIsDesktop from "@/hooks/useIsDesktop"; // Custom hook to detect screen >= 1024px

// // Example fade-in variants
...
//                   initial={isDesktop ? "initial" : true}
//                   whileInView={isDesktop ? "animate" : true}
//                   viewport={isDesktop ? { once: true, amount: 0.3 } : {}}
//                   // only hover scale on desktop
...
//                 whileHover={isDesktop ? { marginBottom: 10, rotate: 5, scale: 1.2 } : {}}
//                 onClick={() => handleTechClick(tech)}
//               >
//                 <Image
//                   src={tech.icon}
...
//         {selectedTech && (
//           <Modal tech={selectedTech} isOpen={isModalOpen} onClose={closeTechModal} />
//         )}

//         {projectModal && (
//           <div className={styles.projectModalOverlay} onClick={closeProjectModal}>
//             <motion.div
//               className={styles.projectModal}
//               onClick={(e) => e.stopPropagation()}

...
export default function AboutImageSection() {
  ...
  // 3) Parallax effect (we'll keep it for all screens unless you want to conditionally disable it)
  useEffect(() => {
  ...
  return (
    <section className={`${styles.aboutImage} ${styles.onceIn}`}>
      <div className={styles.container}>
        ...
        <motion.div
          className={styles.IntroductionContainer}
          // Conditionally apply Framer Motion variants if desktop
        ...
        <div className={styles.row}>
          ...
          >
            ...
            <div className={styles.standOut}>
              ...
              <ul>
                <li>
                  <strong>Business Savvy:</strong> An automotive sales background
                  helps me see the bigger picture and tailor solutions to
                  real-world needs.
                </li>
                <li>
                  <strong>Tech Expertise:</strong> Certified Full Stack
            ...
            <div className={styles.drivemeMain}>
              <div className={styles.DrivesMe}>
                ...
                <ul className={styles.DrivesMeList}>
                  ...
                  <li>
                    <strong>Technical Depth:</strong> Proficient in
                    HTML/CSS/JS, React.js, Next.js, Node.js, Express, MongoDB,
                    plus Drupal for CMS solutions and more.
                  </li>
                  <li>
                    <strong>Collaborative Spirit:</strong> I embrace Agile
